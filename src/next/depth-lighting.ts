...
/**
 * Low-cost lighting rig for the underground architecture. Cool and warm
 * directions reveal material depth without turning the city into neon scenery;
 * small encounter-local accents identify nodes. All lights remain shadowless for
 * mobile performance.
 */
